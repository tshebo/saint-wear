...
export const metadata = {
  ...
  description: "Have questions about Saint Wear products? Contact our team for sales inquiries, support, and business opportunities. We'll get back to you promptly.",
  keywords: "Saint Wear contact, clothing brand contact, custom apparel contact, Johannesburg clothing company, South African apparel contact",
  
  // Open Graph / Facebook Metadata
  openGraph: {
    title: "Contact Saint Wear | Let's Connect",
    description: "Have questions? We'd love to hear from you. Send us a message and we'll get back to you shortly.",
...
export const localBusinessSchema = {
  ...
  "geo": {
    ...
    "longitude": 28.0250  // Replace with actual coordinates
  },

...
import { Printer, Users, Briefcase, Package, CheckCircle2, TrendingUp, ShieldCheck, Clock, ArrowRight, ChevronDown, ChevronUp } from 'lucide-react';
...
export default function CorporatePage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "We use state-of-the-art printing technology and high-quality materials to ensure consistency across all orders, regardless of size. Our quality control process includes multiple checkpoints throughout production, and we offer a quality guarantee on all our products."
    },
    {
      question: "What is the typical turnaround time for corporate orders?",
      answer: "Turnaround times can vary depending on the complexity and size of the order. However, we pride ourselves on our fast turnaround times without compromising on quality. For standard orders, we typically deliver within 7-10 business days. For urgent requests, we offer expedited services. Please contact us for a more accurate estimate based on your specific needs."
    },
    {
      question: "Do you offer bulk pricing for large corporate orders?",
      answer: "Yes, we offer competitive bulk pricing for large corporate orders. The more you order, the more you save. We can provide custom quotes based on your specific requirements and order volume. Please reach out to our sales team for detailed pricing information."
    },
    {
      question: "Can you handle nationwide distribution for corporate uniform programs?",
      answer: "We have experience managing nationwide uniform programs for large corporations. Our logistics team can handle distribution to multiple locations across the country, ensuring that all your employees receive their uniforms in a timely manner."
    }
  ];
        ...
        <FadeInSection>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className={`${bebasNeue.className} text-4xl lg:text-5xl font-bold mb-6`}>
                FREQUENTLY ASKED QUESTIONS
              </h2>
              <p className="text-lg text-gray-600">
                Get answers to common questions about our corporate printing services
              </p>
            </div>
            <div className="space-y-6">

  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Saintwear: Where fashion meets attitude for individuals and businesses. Discover bold, vibrant styles and custom business solutions."
        />
        ...
        <meta
          name="keywords"
          content="fashion, custom clothing, business apparel, bold style, Saintwear, South Africa, Christian Clothing, printing solutions, custom printing"
        />
        ...
        <meta
          property="og:title"
          content="Saintwear | Bold Fashion for Individuals & Businesses"
        />
        <meta
          property="og:description"
          content="Where fashion meets attitude. Discover bold, vibrant styles and custom business solutions at Saintwear."
        />
        <meta
          property="og:image"
          content="https://saintwear.co.za/logo-r.png"
        />
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="/logo-r.png" />
        <link
          rel="icon"
          type="image/png"
          sizes="32x32"

          ...
          {styles.map((style, index) => (
            <div key={index} className="group cursor-pointer">
              ...
              <div className="relative overflow-hidden rounded-xl mb-6">
                {/* Color Overlay */}
                <div className={`absolute inset-0 ${accentColors[style.accent]} transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 z-10 mix-blend-overlay`}/>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div className="absolute bottom-0 left-0 p-6">
                    ...
                    <div className="flex items-center">
                      <span className="text-white text-xs font-medium">Explore Collection</span>
              ...
              <div className="space-y-2">
                <h3 className={`${bebasNeue.className} text-2xl sm:text-3xl font-bold text-white group-hover:text-blue-600 transition-colors`}>
                  {style.title}
                </h3>
              </div>
            </div>

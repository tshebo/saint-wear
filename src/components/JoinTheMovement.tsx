  ...
  return (
    <section className="bg-yellow-400 py-24 px-8">
      <div className="max-w-[2000px] mx-auto text-center">
        <h2
          className={`${bebasNeue.className} text-6xl md:text-8xl font-bold mb-8`}
        >
          JOIN THE MOVEMENT
        </h2>
        <div className="max-w-2xl mx-auto space-y-6">
          <p className="text-xl">
            ...
            the latest from Saintwear for both individuals and businesses.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            />
            <Button className="bg-slate-900 text-white hover:bg-black transition-colors px-8 py-6">
              Subscribe
            </Button>
          </div>
        </div>

...
export default function OurStory({ bebasNeue }: { bebasNeue: any }) {
  return (
    <section className="bg-blue-600 py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="max-w-[2000px] mx-auto relative">
        <div className="max-w-xl mb-12 lg:mb-16">
          <h2 className={`${bebasNeue.className} text-5xl sm:text-6xl lg:text-8xl font-bold text-white leading-none mb-4`}>
            OUR STORY
          </h2>

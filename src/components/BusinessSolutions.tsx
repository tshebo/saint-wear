...
import { ArrowRight, Printer, Palette, Building2, Package, Badge, Users } from 'lucide-react';
  ...
  const features: BusinessFeature[] = [
    {
      ...
      description: "High-quality screen printing, embroidery, and digital prints"
    },
    {
    ...
    },
    {
      ...
      title: "Bulk Orders",
      description: "Volume discounts with consistent quality across large orders"
    }
  ];
    ...
    <section className="bg-gradient-to-br from-blue-600 to-blue-700 py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-[2000px] mx-auto relative">
        ...
        <div className="mb-12 lg:mb-16">
          ...
          <h2 className={`${bebasNeue.className} text-5xl sm:text-6xl lg:text-8xl font-bold text-white leading-none`}>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <p className="text-lg sm:text-xl text-white/90 leading-relaxed">
                Transform your brand with Saintwear&apos;s professional printing solutions. 
                Our printing facility delivers exceptional quality for 
                all your business needs - from custom uniforms to promotional merchandise.
              </p>
              <p className="text-lg sm:text-xl text-white/90 leading-relaxed">
            ...
            <div className="relative overflow-hidden rounded-lg shadow-2xl group">
              ...
              <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-sm rounded-lg p-4 shadow-lg">
                <div className="flex items-center space-x-2 text-blue-600">
                  ...
                  <span className="font-semibold">10K+ Custom Prints Delivered</span>
                </div>
              </div>
            </div>
          </div>
